...
import LessonContainer, {
  ACTIVITIES_QUERY,
} from "../../../components/Lesson/containers/LessonContainer";
...
describe("LessonContainer Component", () => {
  ...
  test("The LessonContainer renders a PDF", async () => {
    ...
    await wait(() =>
      expect(container.querySelector(".ActivityViewerCourse")).toBeDefined()
    );
    ...
    expect(container.querySelector("iframe").src).toBe(
      "http://www.example.com/pdf11.pdf"
    );
  ...
  test("The LessonContainer renders a video", async () => {
    ...
    expect(container.querySelector("source").src).toBe(
      "http://www.example.com/video12.mp4"
    );
